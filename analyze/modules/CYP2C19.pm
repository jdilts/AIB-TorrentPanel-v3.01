...
sub callCYP2C19($$$){
		...
		@ordered = ("CYP2C19s17,148","CYP2C19s2,88","CYP2C19s2,89",	"CYP2C19s3,84",	"CYP2C19s4,76",	"CYP2C19s7,51",	"CYP2C19s6s8s9,115",
					"CYP2C19s6s8s9,42",	"CYP2C19s6s8s9,79");	
		
		########### Main method of callCYP2C19 
...
#			print "$key\n";
		...
		if($message eq ""){
			return "CYP2C19|$message|$finalCall|||||||\n";
		}
		else{
			return "CYP2C19|$message||||||||\n";
		}
