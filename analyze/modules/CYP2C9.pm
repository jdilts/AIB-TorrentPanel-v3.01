...
sub callCYP2C9($$$){
		...
		@ordered = ("CYP2C9s2M,114","CYP2C9s6M,45","CYP2C9s5Ms3Ms11Ms4M,13","CYP2C9s5Ms3Ms11Ms4M,85","CYP2C9s5Ms3Ms11Ms4M,86","CYP2C9s5Ms3Ms11Ms4M,90");	
		...
		if($message eq ""){
			return "CYP2C9|$message|$finalCall|||||||\n";
		}
		else{
			return "CYP2C9|$message||||||||\n";
		}
...
sub buildVariants(){
my(%variations);
%variations = (		"CYP2C9s2M,114" => "T",					
					"CYP2C9s6M,45" => "-",
					"CYP2C9s5Ms3Ms11Ms4M,13" => "T",
					"CYP2C9s5Ms3Ms11Ms4M,85" => "C",
					"CYP2C9s5Ms3Ms11Ms4M,86" => "C",
					"CYP2C9s5Ms3Ms11Ms4M,90" => "G",
				);
	return(\%variations);
} # end buildVariants
...
sub buildStarCalls(){
my(%variations);
%variations = (		"CYP2C9s2M,114" => "2",					
					"CYP2C9s6M,45" => "6",
					"CYP2C9s5Ms3Ms11Ms4M,13" => "11",
					"CYP2C9s5Ms3Ms11Ms4M,85" => "3",
					"CYP2C9s5Ms3Ms11Ms4M,86" => "4",
					"CYP2C9s5Ms3Ms11Ms4M,90" => "5",					
				);
	return(\%variations);
} # end buildVariants
